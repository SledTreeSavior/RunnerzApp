package dev.savoie.runnerz.run;
...
class RunControllerTest {
    ...
    void shouldCreateNewRun() throws Exception {
        var run = new Run(null,"test", LocalDateTime.now(),LocalDateTime.now().plusMinutes(2),1, Location.INDOOR);
    ...
    void shouldUpdateRun() throws Exception {
        var run = new Run(null,"test", LocalDateTime.now(),LocalDateTime.now().plusMinutes(3),1, Location.INDOOR);
